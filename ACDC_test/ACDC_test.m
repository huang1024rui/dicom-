...
clear all;
clc;
nii = load_nii( 'C:\Users\HQR\Desktop\ACDC_test\patient001_frame01.nii.gz' );  % 装载.nii数据
img = nii.img;  % 因为这个文件有img和head二个部分，其中img部分是图像数据
save patient001_frame01.mat img  % 将数据变成mat格式
load 'patient001_frame01.mat'  % 加载数据
...
nii1 = load_nii( 'C:\Users\HQR\Desktop\ACDC_test\patient001_frame12.nii.gz' );  % 装载.nii数据
img1 = nii1.img;  % 因为这个文件有img和head二个部分，其中img部分是图像数据
save patient001_frame12.mat img1  % 将数据变成mat格式
load 'patient001_frame12.mat'  % 加载数据
